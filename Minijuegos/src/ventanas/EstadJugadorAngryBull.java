...
public class EstadJugadorAngryBull {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EstadJugadorAngryBull window = new EstadJugadorAngryBull();
	...
	private void initialize() {
		...
		lblPorcentajeVictorias.setBounds(61, 161, 159, 14);
		...
		btnAtras.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				EleccionEstadAngryBull a=new EleccionEstadAngryBull();
