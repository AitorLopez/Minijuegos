...
public class ComparaRecordsAngryBull {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ComparaRecordsAngryBull window = new ComparaRecordsAngryBull();
	 ...
	 */
	public ComparaRecordsAngryBull() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblComparacion = new JLabel("COMPARACI\u00D3N DE RECORDS ANGRY BULL");
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			EstadiJugadorAngryBull a=new EstadiJugadorAngryBull();
